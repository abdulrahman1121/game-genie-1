  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/openai/start`, {
      ...
      .then(async data => {
        ...
        setIsGameReady(true);
        setShowWelcomeModal(session.isNewSession);
  ...
  <div className="game-page">
    ...
    <div className="game-container">
      <Grid
        ...
        hints={hints}
      />
      <div className="genie-container" style={{ opacity: hint ? 1 : 0, zIndex: hint ? 1000 : 0 }}>
...
<div className="welcome-modal" style={{ opacity: showWelcomeModal ? 1 : 0, pointerEvents: showWelcomeModal ? 'auto' : 'none' }}>
  <div className="welcome-modal-content">
    ...
    {modalButtonType === 'start' ? (
      ...
      <button className="welcome-close-button" onClick={() => {
        ...
        <img src={`${import.meta.env.BASE_URL}close-all.png`} alt="close" className="welcome-close-btn" />
      </button>
    )}
  </div>
</div>
      <div className="game-over-modal" style={{ opacity: gameStatus !== 'active' ? 1 : 0, pointerEvents: gameStatus !== 'active' ? 'auto' : 'none' }}>
